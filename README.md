...
For example, if you were connecting to Twitter, you would want a com.codepath.apps.mysimpletweets.models.Tweet model as follows:

```java
// models/com.codepath.apps.mysimpletweets.models.Tweet.java
...
public class com.codepath.apps.mysimpletweets.models.Tweet extends BaseModel {
...
public class com.codepath.apps.mysimpletweets.models.Tweet extends BaseModel {
  ...
  public com.codepath.apps.mysimpletweets.models.Tweet(JSONObject object){
    super();
  ...
  public static ArrayList<com.codepath.apps.mysimpletweets.models.Tweet> fromJson(JSONArray jsonArray) {
    ArrayList<com.codepath.apps.mysimpletweets.models.Tweet> tweets = new ArrayList<com.codepath.apps.mysimpletweets.models.Tweet>(jsonArray.length());
    ...
    for (int i=0; i < jsonArray.length(); i++) {
        ...
        com.codepath.apps.mysimpletweets.models.Tweet tweet = new com.codepath.apps.mysimpletweets.models.Tweet(tweetJson);
        tweet.save();
        tweets.add(tweet);
    }
...
```java
ArrayList<com.codepath.apps.mysimpletweets.models.Tweet> tweets = com.codepath.apps.mysimpletweets.models.Tweet.fromJSON(jsonArray);
```

or load the data from a single `JSONObject` with:

```java
com.codepath.apps.mysimpletweets.models.Tweet t = new com.codepath.apps.mysimpletweets.models.Tweet(json);
// t.body = "foo"
t.save();
```
